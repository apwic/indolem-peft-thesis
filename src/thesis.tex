...
%Basic configuration
\title{Penggunaan Berbagai Metode \textit{Parameter-Efficient Transfer Learning} pada Kakas Evaluasi IndoLEM}
\date{} 
\author{
...
\newcommand\PETL{\textit{parameter-efficient transfer learning}}
\newcommand\methodPETL{LoRA, \textit{Prefix-Tuning}, dan \textit{Bottleneck Adapter}}
