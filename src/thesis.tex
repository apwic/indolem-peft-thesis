...
%Basic configuration
\title{Pemanfaatan Berbagai Metode \textit{Parameter Efficient Fine-Tuning} pada Kakas Evaluasi IndoLEM}
\date{} 
\author{
...
\newcommand\PEFT{\textit{parameter efficient fine-tuning} (PEFT)\space}
\newcommand\methodPEFT{LoRA, Prefix Tuning, Bottleneck Adapter, dan UniPELT\space}
\newcommand\nlptask{\textit{named entity recognition} (NER), \textit{sentiment analysis}, dan \textit{summarization}\space}
