...
%Basic configuration
\title{Pemanfaatan Metode \textit{Parameter Efficient Fine-Tuning} pada Kakas Evaluasi IndoLEM}
\date{} 
\author{
...
\newcommand{\methodPEFT}{LoRA, Prefix Tuning, Bottleneck Adapter, dan UniPELT\xspace}
